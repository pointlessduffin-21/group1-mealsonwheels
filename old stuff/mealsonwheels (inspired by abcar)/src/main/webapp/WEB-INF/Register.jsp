...
<div class="container my-3">
    ...
    <sf:form action="register" method="post" class="was-validated" modelAttribute="user">
        ...
        <div class="mb-3 mt-3">
            <label for="contact" class="form-label">Contact:</label> <sf:input
                type="text" class="form-control"
                placeholder="Enter contact" name="contact" path="contact" required="true" />
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback">Please fill out this field.</div>
        </div>
        <div class="mb-3 mt-3">
            <label for="age" class="form-label">Age:</label> <sf:input
                type="text" class="form-control"
                placeholder="Enter age" name="age" path="age" required="true" />
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback">Please fill out this field.</div>
        </div>
        <div class="mb-3">
